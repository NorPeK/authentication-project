  ...
  return (
    ...
    >
        <div className='p-8'>
            ...
            text-center bg-gradient-to-r from-green-400
            to-emerald-500 text-transparent
            bg-clip-text'>Create Account</h2>
            ...
            <form onSubmit={handleSignUp}>
                ...
                />
                {error && <p className='text-red-5-- font-semibold mt-2'>{error}</p>}
